...
gem 'mysql2', '~> 0.3.0'
gem 'nokogiri', '~> 1.6.0'
gem 'oai', '~> 0.3.0', :git => 'https://github.com/rwd/ruby-oai', :branch => 'activerecord-table-name'
gem 'oauth2', '~> 0.9.2'
gem 'openskos', '~> 0.0.1', :git => 'https://github.com/europeana/openskos-client-ruby'
gem 'paperclip', '~> 2.7.6', :git => 'https://github.com/rwd/paperclip', :branch => 'v2.7'
gem 'paperclip-meta', '~> 0.4.3', :git => 'https://github.com/rwd/paperclip-meta'
